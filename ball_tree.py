...
def ball_tree_clustering(data: np.ndarray, radius: float) -> list:
    """
    Run HCM clustering using BallTree neighbor search.

    Args:
        data (np.ndarray): Nx3 array of (a, e, sin(i))
        radius (float): distance cutoff
